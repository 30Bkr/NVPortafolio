  ...
  return (
    <div className={`py-18 ${styles.contenedor} w-full grid grid-cols-4`}>
      <div className={`col-span-3 ${styles.blog}`} id='contenido'>
        ...
        <div id='conectores' className='pt-8'>
        ...
        <div id='especificaciones' className='pt-8'>
      ...
      <div id='side-bar' className='col-span-1 relative'>
        ...
        <ul>
          ...
          <Link href={'/comunicaciones#medios'}>
            <li>Medios de conexión de redes</li>
          </Link>
          <Link href={'/comunicaciones#cables'}>
            <li>Tipos de cables</li>
          </Link>
          <Link href={'/comunicaciones#conectores'}>
            <li>Implementación del cableado con RJ45</li>
          </Link>
          <Link href={'/comunicaciones#especificaciones'}>
            <li>Especificaciones de cables</li>
          </Link>
        </ul>
        </div>
