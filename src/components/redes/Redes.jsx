    ...
    <div className=" w-full h-full pt-16 mt-16 lg:relative" id="redes">
      <div className={`xl:${styles.contenedor} xl:grid xl:grid-cols-3 xl:justify-around flex flex-col`}>
        <div className={` lg:col-span-2 flex flex-col lg:px-20 px-4 justify-center`}>
          ...
          <p className='text-gray-900 '>La dependencia de procesos manuales para la gestión de inscripciones y otros trámites administrativos no solo consume un tiempo valioso, sino que también da lugar a errores y a la pérdida de documentación importante. En un contexto donde el número de estudiantes es considerable y el personal encargado de la administración es limitado, la situación se vuelve insostenible. Esto deja a los estudiantes en un estado de incertidumbre, esperando respuestas y acceso a los documentos que necesitan para continuar su desarrollo académico.</p>
